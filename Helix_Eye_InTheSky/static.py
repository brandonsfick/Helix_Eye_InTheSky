...
root = r'/Users/BFick/Dropbox/Apps/Camera_Images/Apps/Camera_Images/'  # path to jpgs or folders of jpgs and output root
tmp = '/tmp'              # temporary folder to move corrupt files to
index = 'all_images.html'      # filename for html files
